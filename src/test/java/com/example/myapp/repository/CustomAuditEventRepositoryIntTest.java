...
import com.example.myapp.config.audit.AuditEventConverter;
import com.example.myapp.domain.PersistentAuditEvent;
...
import static com.example.myapp.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
