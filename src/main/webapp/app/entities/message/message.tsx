    ...
    return (
      <div>
        <h2 id="message-heading">
          <Translate contentKey="myappApp.message.home.title">Messages</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />&nbsp;
            <Translate contentKey="myappApp.message.home.createLabel">Create new Message</Translate>
          </Link>
        </h2>
